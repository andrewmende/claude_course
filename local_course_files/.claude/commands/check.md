Grade the learner's answer for the current task.

1. Ask the learner to paste their code if not already provided in this message.
2. Call `submit_answer` with learner_id and their code.
3. Report the result:
